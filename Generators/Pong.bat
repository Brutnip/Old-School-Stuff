...
if %bv%==-1 set bv=3
echo enter number of players 1/2
set /p pnum=
if %pnum%==2 goto cont
set i=
set k=
...
if %pnum%==1 goto cont23
CHOICE /C WSIKPV /N /T 1 /D V
IF ERRORLEVEL 6 goto start2
IF ERRORLEVEL 5 goto menu
IF ERRORLEVEL 4 goto rup
IF ERRORLEVEL 3 goto rdo
IF ERRORLEVEL 2 goto lup
IF ERRORLEVEL 1 goto ldo
:cont23
CHOICE /C WSPV /N /T 1 /D V
...
:ai
if dir=r goto contai
set /a b=%random% * 2 / 32768
if %b%==0 goto contai
if %hnum% GEQ %rpos% set /a rpos=%rpos% + 1
if %hnum% LEQ %rpos% set /a rpos=%rpos% - 1
goto contai
